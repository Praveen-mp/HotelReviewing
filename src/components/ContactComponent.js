                    ...
                    <Form model="feedback" onSubmit={(values)=>this.handleSubmit(values)}>
                        <Row className="form-group">
                         ...
                         show="touched"
                          messages={{
                            required:'Required',
                            minLength:'error enter valid letters',
                        ...
                        <Row className="form-group">
                           ...
                           <Col md={10}>
                           <Control.text model=".telnum" id="telnum" name="telnum" placeholder="Ph No:" 
                           className="form-control"
                           validators={{
                        ...
                        <Row className="form-group">
                            <Col md={{size:6,offset:2}}>
                                <div className="form-check">
                                    <Label check>
                                        <Control.checkbox model=".agree" type="checkbox" id="agree" name="agree" 
